...
public class JobDAO
{
    private static final String URL = "jdbc:sqlite:C:\\Users\\dev\\IdeaProjects\\HrApiDay07-EV\\src\\main\\java\\org\\example\\hr.db";
    ...
    public ArrayList<Jobs> selectAllJob(JobFilterDto jobFilter) throws SQLException, ClassNotFoundException {
